...
//    //Makale Route's
//    Route::get('makaleler/silininler', 'Back\ArticleController@trashed')->name('trashed.article');
//    Route::resource('makaleler', 'Back\ArticleController');
//    Route::get('swich', 'Back\ArticleController@swich')->name('swich');
...
//    Route::get('kategoriler/status', 'Back\CategoryController@swich')->name('category.swich');
