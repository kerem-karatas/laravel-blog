...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('homepage')}}">
            ...
            <div class="sidebar-brand-text mx-3">Blog Sitesi </div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse @if(Request::segment(2)=="makaleler") show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Makale İslemleri:</h6>
                    <a class="collapse-item @if(Request::segment(2)=="makaleler" && Request::segment(3)!= "olustur") active @endif" href="{{route('admin.makaleler.index')}}">Tüm Makaleler</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePage" class="collapse @if(Request::segment(2)=="sayfalar") show @endif" aria-labelledby="headingPage" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Sayfa  İslemleri:</h6>
                    <a class="collapse-item @if(Request::segment(2)=="sayfalar" && Request::segment(3)!= "olustur") active @endif" href="{{route('admin.page.index')}}">Tüm Sayfalar</a>
                    <a class="collapse-item @if(Request::segment(2)=="sayfalar" && Request::segment(3)== "olustur") active @endif" href="{{route('admin.page.create')}}">Sayfa Oluştur </a>
                </div>
            </div>
        </li>
